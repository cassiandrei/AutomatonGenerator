...
- automato.py: possui as definições de um automato, fita, estados e transições. Contém os métodos de geração  e validação da entrada do programa.
...
Descrição:
O programa executa a partir do main.py gerando a gramática dada pelo arquivo Automato.txt. A geração é feita a partir da lib ANTLR4.
