...
class AutomatonGrammarParser ( Parser ):
    ...
    class RContext(ParserRuleContext):
        ...
        def ID(self):
            return self.getToken(AutomatonGrammarParser.ID, 0)

        def getRuleIndex(self):
            return AutomatonGrammarParser.RULE_r
    ...
    def r(self):
        ...
        localctx = AutomatonGrammarParser.RContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.state = 3
            self.match(AutomatonGrammarParser.ID)
